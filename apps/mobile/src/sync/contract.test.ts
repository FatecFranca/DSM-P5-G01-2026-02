...
describe("contrato da API de sync", () => {
  ...
  it("envia progresso com metadados de domínio", () => { const event: SyncEvent = { id: "p", type: "progress", payload: { lessonId: "letter-a", completedTypes: ["listen_choose", "recognize"], score: 2, completed: false, updatedAt: "2026-01-01T00:00:00Z" } }; expect(toApiEvent(event)).toEqual({ client_event_id: "p", type: "progress", occurred_at: "2026-01-01T00:00:00Z", payload: { lesson_id: "letter-a", status: "in_progress", completed_exercises: 2, completed_types: ["listen_choose", "recognize"], attempts: 0, correct_attempts: 0, accuracy: null, review_count: 0, last_practiced_at: null, next_review_at: null } }); });
